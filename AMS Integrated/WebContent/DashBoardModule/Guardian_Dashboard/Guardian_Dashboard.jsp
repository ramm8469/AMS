...
<nav class="navbar navbar-inverse"; style="background-color: #34495E">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-center">
        <h1 style="color: white">Guardian Dashboard</h1>
    </ul>
...
<div class="container-fluid">
	  ...
	  <div class="card" >
	  <iframe src="DashBoardModule/Guardian_Dashboard/frame1.jsp" name="frame1"  height="700px" scrolling="yes"; style="margin-right: -30px"></iframe>
	  </div>
</div>
<div class="col-sm-12 col-md-10 col-lg-10">
	  <div class="card">
	  <iframe src="DashBoardModule/Guardian_Dashboard/frame2.jsp" name="frame2" height="700px" scrolling="yes"></iframe>
	  </div>
</div>
