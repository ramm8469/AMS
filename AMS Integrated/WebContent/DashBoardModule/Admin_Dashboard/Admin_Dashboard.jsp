...
<div class="container-fluid">
	  ...
	  <div class="card" >
	  <iframe src="DashBoardModule/Admin_Dashboard/frame1.jsp" name="frame1"  height="700px" scrolling="yes"; style="margin-right: -30px"></iframe>
	  </div>
</div>
<div class="col-sm-12 col-md-10 col-lg-10">
	  <div class="card">
	  <iframe src="DashBoardModule/Admin_Dashboard/frame2.jsp" name="frame2" height="700px" scrolling="yes"></iframe>
	  </div>
</div>   
</div>
    </div>
